...
class LibraryPage:
    ...
    def view_requests(self):
        try:
            ...
            sql = "SELECT * FROM reserved_books WHERE regdno = %s"
...
class AdminPage:
    ...
    def insert_into_available_books(self, book_name, author_name):
        try:
            sql = "INSERT INTO availablebooks (book, author) VALUES (%s, %s)"
    ...
    def insert_into_books_dataset(self, book_name, author_name):
        try:
            sql = "INSERT INTO books_dataset (book, author) VALUES (%s, %s)"
            values = (book_name, author_name)
            self.cursor.execute(sql, values)
            self.db.commit()
    ...
    def show_requests(self):
        ...
        try:
            ...
            self.cursor_reserved_books.execute("SELECT * FROM reserved_books")
    ...
    def refresh_reserved_books(self):
        try:
            ...
            self.cursor.execute("SELECT * FROM reserved_books")
...
class RequestsPage:
    ...
    def mark_as_done(self, request):
        try:
            ...
            sql = "DELETE FROM reserved_books WHERE regdno = %s AND book = %s AND author = %s"
